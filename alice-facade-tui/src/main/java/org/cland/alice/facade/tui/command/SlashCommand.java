 ...
 * 命令分为三类：
 * <ul>
 *   <li>Type A（内部）：仅操作 UI/会话状态 — /new, /clear, /exit, /help</li>
 *   <li>Type B（IO 操作）：读取文件等 — /prompt, /history</li>
 *   <li>Type C（系统）：执行 shell 命令 — /exec</li>
 *   <li>Type D（模型/工具）：修改运行时行为 — /model, /tools</li>
 * </ul>
 */
