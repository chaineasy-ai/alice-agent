...
public final class Call {
    ...
    private Call(Builder builder) {
        ...
        this.attributes = builder.attributes != null ? new ConcurrentHashMap<>(builder.attributes) : new ConcurrentHashMap<>();
    }
    ...
    public Response result()         { return result; }
