...
/**
 * Gemma4 模型适配器 (OpenAI-compatible), 对应本地部署的 Gemma-4 API 服务。
 * API 地址: http://192.168.1.14:10303/v1/chat/completions
 * 使用 OpenAI Chat Completion 协议，支持 Function Calling。
 */
public class Gemma4Supplier implements ModelSupplier {
    ...
    private String buildRequestBody(Call.Payload payload) {
        ...
        sb.append("\"messages\":[{\"role\":\"user\",\"content\":\"").append(escapeJson(payload.prompt())).append("\"}],");
    ...
    private Call.Response parseResponse(String responseBody, String modelId) {
        try {
            ...
            Call.TokenUsage usage = (promptStr != null || completionStr != null)
