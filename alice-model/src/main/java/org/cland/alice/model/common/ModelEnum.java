...
public enum ModelEnum {
    ...
    ModelEnum(String modelId, String supplierName, Capability capability,
    ...
    public double inputPricePer1K()  { return inputPricePer1K; }
    public double outputPricePer1K() { return outputPricePer1K; }
