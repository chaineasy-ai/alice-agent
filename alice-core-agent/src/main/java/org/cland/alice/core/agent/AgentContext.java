 ...
 * <p>
 * 对应设计文档中 AgentContext，承载：
 * <ul>
 *   <li>用户输入 / 环境信号</li>
 *   <li>会话 ID (sessionId)</li>
 *   <li>循环迭代计数器 (iteration)</li>
 *   <li>最大迭代限制 (maxIterations)</li>
 *   <li>思考链 (thoughtChain)</li>
 *   <li>最终结果</li>
 *   <li>任意扩展属性</li>
 * </ul>
 */
public class AgentContext {
    ...
    /** 获取当前迭代次数 */
    public int iteration()                  { return iteration.get(); }

    /** 增加迭代计数并返回新值 */
    public int incrementIteration()         { return iteration.incrementAndGet(); }

    /** 检查是否达到最大迭代限制 */
    public boolean isMaxIterationsReached() { return iteration.get() >= maxIterations; }
    ...
    public String toString() {
        return "AgentContext{session='" + sessionId
