 ...
 * PPAO 循环中每一步的密封结果类型。
 *
 * <p>对应设计文档中 StepResult 密封类，支持模式匹配：
 *
 * <ul>
 *   <li>{@link Continue} — 继续执行下一步 Action
 *   <li>{@link Finish} — 循环结束，返回最终答案
 *   <li>{@link Failure} — 发生不可恢复错误
 * </ul>
 */
public abstract sealed class StepResult
