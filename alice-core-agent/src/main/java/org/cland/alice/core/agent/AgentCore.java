 ...
 * <p>
 * 对应设计文档中的 AgentCore，作为 Perceive-Plan-Act-Observe-Vefify 闭环的中央控制器。
 * 它持有所有子模块的引用，并通过 {@link AgentExecutor} 驱动整个循环。
 * <p>
 * 生命周期状态机参见设计文档：
 * <pre>
...
public class AgentCore {
    ...
    public AgentExecutor executor()             { return executor; }
    public ReAct planner()                      { return planner; }
    public Verificator guardrail()              { return guardrail; }
    public ToolRegistry toolRegistry()          { return toolRegistry; }
    public AgentSession memory()                { return memory; }
    public EnvEvent envAdapter()                { return envAdapter; }
