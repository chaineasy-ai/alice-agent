...
/**
 * Environment event — emitted by {@link EnvManager} when significant environment state changes
 * occur (client connections, resource changes, etc.).
 *
 * <p>Leverages MCP 2.0's subscription mechanism to detect resource changes and propagate them as
 * events to the AgentCore and other listeners.
 */
public final class EnvEvent {
  ...
  public String toString() {
    return "EnvEvent{type=" + type + ", source='" + source + "', timestamp=" + timestamp + "}";
  }
}
