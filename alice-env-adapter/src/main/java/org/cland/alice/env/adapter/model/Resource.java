...
/**
 * MCP 2.0 Resource descriptor, representing an external resource that can be read
 * or subscribed to via an MCP server.
 * <p>
 * Resources are the primary mechanism for the environment to expose stateful
 * data (files, database entries, API responses) to the Agent.
 */
