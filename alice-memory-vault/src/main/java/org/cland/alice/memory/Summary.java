 ...
 * <p>
 * 包含从交互中萃取的事实（Facts）和成功模式（Success Patterns），
 * 分别用于填充 SemanticVault 和 ProceduralVault。
 */
public final class Summary {
    ...
    private Summary(Builder builder) {
        ...
        this.successPatterns = builder.successPatterns != null
                ? List.copyOf(builder.successPatterns)
                : List.of();
    ...
    public List<String> successPatterns() { return successPatterns; }
