 ...
 *
 * <p>对应设计文档：SemanticVault / VectorStore + EmbeddingModel 角色。 物理载体建议：Qdrant / Milvus（当前提供内存实现，含简易
 * TF-IDF 检索）。
 *
...
public final class SemanticVault {
  ...
  public String toString() {
    ...
    return "SemanticVault{collections=%d, totalKnowledge=%d}".formatted(collections.size(), total);
  }
}
