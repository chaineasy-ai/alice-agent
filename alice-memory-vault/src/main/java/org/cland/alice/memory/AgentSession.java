 ...
 * <p>
 * 对应设计文档中 MemoryVault (M) 的角色，支持：
 * <ul>
 *   <li>按 sessionId 存取上下文记忆</li>
 *   <li>持久化观测结果</li>
 *   <li>长期 / 短期记忆的分层管理</li>
 * </ul>
 */
public class AgentSession {
    ...
    public void persist(String sessionId, String data) {
        shortTermMemory.computeIfAbsent(sessionId, k -> new StringBuilder())
            .append(data).append("\n");
    }
    ...
    public void putLongTerm(String key, Object value) {
        longTermMemory.computeIfAbsent("_global", k -> new ConcurrentHashMap<>())
            .put(key, value);
    }
