 ...
 *
 * <p>MemorySet 是不可变集合，支持不同类型的记忆条目， 供 Planner 融合到 Context Window 中。
 */
public final class MemorySet implements Iterable<MemorySet.Entry> {
  ...
  public record SemanticEntry(String knowledgeId, String content, double score) implements Entry {
    @Override
    public VaultType vaultType() {
