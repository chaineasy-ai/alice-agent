 ...
 * <p>
 * 对应设计文档中状态机 "Routing to Episodic / Semantic / Procedural" 的角色。
 * <p>
 * 路由逻辑：
 * <ol>
 *   <li>如果上下文涉及"刚才/之前做了什么" → 路由到 EpisodicVault</li>
 *   <li>如果上下文涉及"这是什么技术/概念" → 路由到 SemanticVault</li>
 *   <li>如果上下文涉及"如何执行这个工具" → 路由到 ProceduralVault</li>
 *   <li>如果无明确倾向 → 三种 vault 都查询，结果融合</li>
 * </ol>
 */
public final class MemoryRouter {
    ...
    public MemoryRouter(EpisodicVault episodicVault,
        ...
        this.proceduralVault = Objects.requireNonNull(proceduralVault, "proceduralVault must not be null");
    }
    ...
    public String toString() {
        return "MemoryRouter{episodic=%d sessions, semantic=%d collections, procedural=%d sops}"
                .formatted(episodicVault.sessionCount(),
