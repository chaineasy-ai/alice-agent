 ...
 * 记忆控制器——三段式记忆系统的统一入口。
 * <p>
 * 对应设计文档中 VaultController 的角色，以组合模式统一管理
 * {@link EpisodicVault}、{@link SemanticVault} 和 {@link ProceduralVault}。
 * <p>
 * 核心职责：
 * <ul>
 *   <li><b>recall(Context)</b>：根据查询上下文检索相关记忆</li>
 *   <li><b>memorize(Experience)</b>：摄入一次交互经验</li>
 *   <li><b>finalizeSession(sessionId)</b>：会话结束时触发记忆合并（Consolidation）</li>
 * </ul>
 */
public final class VaultController {
    ...
    public VaultController() {
        ...
        this.consolidationExecutor = Executors.newSingleThreadExecutor(r -> {
    ...
    public VaultController(EpisodicVault episodicVault,
     ...
     * <p>
     * 对应设计图中 {@code recall(Context) → MemorySet}。
     *
     * @param ctx 查询上下文
     * @return 融合后的记忆集合
     */
     ...
     * <p>
     * 对应设计图中 {@code memorize(Experience)}。
     *
     * @param exp 本次交互经验
     */
    ...
    public MemoryRouter router() { return router; }
    public EpisodicVault episodicVault() { return episodicVault; }
    public SemanticVault semanticVault() { return semanticVault; }
    public ProceduralVault proceduralVault() { return proceduralVault; }
    public StorageBackend storage() { return storage; }
    public MemorySummarizer summarizer() { return summarizer; }
