...
Footer 渲染格式：
```text
[48;5;208m💰 $0.041  [48;5;35m📊 125 t/s  [48;5;239m🧠 gpt-4o  ── 🔌 Active: cland-pay-mcp
```
...
| Footer 费用 | `30` | `48;5;208` 橙黄 | 实体色块按钮 |
| Footer 速率 | `30` | `48;5;35` 绿色 | 实体色块按钮 |
| Footer 模型 | `37` | `48;5;239` 暗灰 | 实体色块按钮 |
