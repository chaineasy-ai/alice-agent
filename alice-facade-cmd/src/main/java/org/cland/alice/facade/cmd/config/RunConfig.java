 ...
 * <p>
 * 对应设计文档中 {@code RunConfig} 实体，由 {@code CommandParser} 创建，
 * 传递给 {@code ExecutionCoordinator} 驱动 Agent 执行。
 *
 * <pre>
 *   RunConfig {
 *     String task;          // 任务描述（必填）
...
public final class RunConfig {
    ...
    private RunConfig(Builder builder) {
        ...
        this.envVars = builder.envVars != null
            ? Map.copyOf(builder.envVars)
            : Map.of();
    }
    ...
    /** 额外环境变量 */
    public Map<String, String> envVars()    { return envVars; }
    ...
    public String toString() {
        return "RunConfig{task='" + task + "', model='" + model
