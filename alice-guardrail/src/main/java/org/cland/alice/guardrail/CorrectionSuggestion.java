 ...
 *
 * <p>当审计失败时，提供具体的修正指导，供 Planner 重新规划使用。 包含建议类型、详细描述和可选的结构化修正数据。
 */
