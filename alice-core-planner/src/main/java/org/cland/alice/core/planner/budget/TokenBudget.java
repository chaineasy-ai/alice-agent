 ...
 * <p>
 * 在 Slow Path 的 MCTS 搜索中，设置 TokenBudget 并监控消耗。
 * 当搜索深度或消耗超过阈值时，强制回退到当前最优分支。
 * <p>
 * 使用示例：
 * <pre>
...
public final class TokenBudget {
    ...
    /** 无限制预算 */
    private static final TokenBudget UNLIMITED = new TokenBudget(Integer.MAX_VALUE, Integer.MAX_VALUE);
    ...
    public int consumedTokens()      { return consumedTokens.get(); }
    public int currentDepth()        { return currentDepth; }
    public int remainingTokens()     { return maxTokens - consumedTokens.get(); }
    ...
    public String toString() {
        return "TokenBudget{tokens=" + consumedTokens.get() + "/" + maxTokens
