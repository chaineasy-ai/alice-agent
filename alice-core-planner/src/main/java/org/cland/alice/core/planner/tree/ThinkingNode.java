 ...
 * 每个节点包含：
 * <ul>
 *   <li>State (S) — 当前 AgentContext 快照</li>
 *   <li>Action (A) — 规划执行的操作</li>
 *   <li>Value (V) — 模型或验证器给出的该路径得分 (reward)</li>
 *   <li>Thought — LLM 的推理过程文本</li>
 *   <li>访问计数 (visits) — MCTS 回溯用</li>
 * </ul>
 */
public final class ThinkingNode {
    ...
    public String actionTarget()                  { return actionTarget; }
    public Map<String, Object> actionParams()     { return actionParams; }
    public String thought()                       { return thought; }
    public double reward()                        { return reward.get(); }
    public int visits()                           { return visits.get(); }
    public String observation()                   { return observation.get(); }
    public ThinkingNode parent()                  { return parent; }
    ...
    /**
     * 计算 UCT (Upper Confidence Bound Applied to Trees) 值。
     * 用于子节点选择。
     *
    ...
    public static final class Builder {
        ...
        public Builder actionTarget(String actionTarget)         { this.actionTarget = actionTarget; return this; }
        public Builder actionParams(Map<String, Object> p)       { this.actionParams = p; return this; }
        ...
        public Builder visits(int visits)                        { this.visits = visits; return this; }
        public Builder observation(String observation)           { this.observation = observation; return this; }
        public Builder parent(ThinkingNode parent)               { this.parent = parent; return this; }

        public ThinkingNode build() { return new ThinkingNode(this); }
    }
}
