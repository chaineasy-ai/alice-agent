 ...
 * <p>
 * 将 Planner 从简单的"提示词包装器"提升为具有元认知能力的工程模块。
 * <p>
 * <b>核心类图：</b>
 * <pre>
 ...
 * <b>包结构：</b>
 * <ul>
 *   <li>{@code model} — 模型抽象层 (ModelSession, ModelSupplier, ModelCapabilities)</li>
 *   <li>{@code strategy} — 策略模式实现 (FastPathStrategy, SlowPathStrategy, StrategySelector)</li>
 *   <li>{@code tree} — MCTS 思维树 (ThinkingNode, ThinkingTree)</li>
 *   <li>{@code sop} — 静态规划 (SopRegistry, StaticPlanner)</li>
 *   <li>{@code budget} — Token 预算控制 (TokenBudget)</li>
 * </ul>
 */
