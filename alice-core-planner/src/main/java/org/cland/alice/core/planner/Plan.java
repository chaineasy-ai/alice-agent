 ...
 * <p>
 * 对应设计文档中 Plan 领域对象，可包含一系列步骤或单一 Action 意图。
 * 由 {@link PlannerService#plan(AgentContext)} 返回。
 */
public final class Plan {
    ...
    public static final class Step {
        private final String actionType;    // "LLM_INFERENCE" | "TOOL_CALL" | "FINISH" | "REVISION" | "OBSERVE"
        ...
        public static Step of(String actionType, String target, Map<String, Object> parameters, String thought) {
